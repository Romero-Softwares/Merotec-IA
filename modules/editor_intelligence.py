...
_VOCABULARY = {
    ...
    ".cpp": ("class", "namespace", "public", "private", "const", "auto", "return", "std", "include", "using"),
    ".cc": ("class", "namespace", "public", "private", "const", "auto", "return", "std", "include", "using"),
    ".cxx": ("class", "namespace", "public", "private", "const", "auto", "return", "std", "include", "using"),
